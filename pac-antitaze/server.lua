...
AddEventHandler('weaponDamageEvent', function(sender, data)
    ...
    if getWeapon == Config.CheckingWeapons then
        TriggerClientEvent('pac-antitaze:check', sender)
    end
end)

RegisterServerEvent("pac:antitaze", function(source, subject, description)
    local src = source
    if (Config.Ban) then
